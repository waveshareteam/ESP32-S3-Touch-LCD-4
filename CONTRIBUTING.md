...
ESP-IDF examples live under `examples/esp-idf/`. Arduino product sketches live under `examples/Arduino-v3.3.2/examples/` and use bundled libraries from `examples/Arduino-v3.3.2/libraries/`.
