...
`examples/esp-idf/08_ESP32-S3-Touch-LCD-4-esp-brookesia` is a source-maintained rich UI example. CI builds it with ESP-IDF `v5.5.4` and `v6.0.2` through the shared `Build Examples` workflow.
